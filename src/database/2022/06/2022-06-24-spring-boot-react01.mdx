...
modified: 2023-09-05 13:17:55 +0000
...
<div
  id='app'
  class='p-2 border rounded-3 display-board'
  style={{ fontFamily: "Montserrat", letterSpacing: ".1px", lineHeight: 1.0 }}>
  <div class='parsed-data' style={{ fontSize: "14px" }}>
