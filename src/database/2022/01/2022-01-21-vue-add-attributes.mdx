...
<span className="w-inline-block">
   <img src="/assets/images/post/vue/attributes/attrs01.png" alt="attr01" title="attr01" />
...
<figure className="text-center">
<span className="w-inline-block">
   <img src="/assets/images/post/vue/attributes/attrs02.png" alt="attr02" title="attr02" />
