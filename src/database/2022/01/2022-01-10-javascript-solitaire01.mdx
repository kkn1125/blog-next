...
<span className="w-inline-block">
   <img src="/assetshttps://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Set_of_playing_cards_52.JPG/800px-Set_of_playing_cards_52.JPG" alt="위키 백과 - 플레잉카드" title="위키 백과 - 플레잉카드" />
...
<figure className="text-center">
<span className="w-inline-block">
   <img src="/assets/images/post/solitaire/solitaire01.png" alt="Solitaire 형태" title="Solitaire 형태" />
...
<figure className="text-center">
<span className="w-inline-block">
   <img src="/assets/images/post/solitaire/solitaire02.png" alt="틀" title="틀" />
