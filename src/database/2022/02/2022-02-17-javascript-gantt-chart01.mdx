...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img
      src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/GanttChartAnatomy.png/300px-GanttChartAnatomy.png'
      alt='위키 백과 - 플레잉카드'
      title='위키 백과 - 간트 차트'
    />
...
window.addEventListener("change", (ev) => {
  ...
  let autoValue = [...document.querySelectorAll(`#${target.id}`)].reduce(
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img src='/assets/images/post/gantt/gantt01.png' alt='sample' title='sample' />
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img src='/assets/images/post/gantt/gantt02.png' alt='sample' title='sample' />
    <figcaption>현재 작업된 내용</figcaption>
  </span>
</figure>
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img src='/assets/images/post/gantt/gantt03.png' alt='sample' title='sample' />
    <figcaption>현재 작업된 내용</figcaption>
  </span>
</figure>
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img src='/assets/images/post/gantt/gantt04.png' alt='sample' title='sample' />
    <figcaption>현재 작업된 내용</figcaption>
  </span>
</figure>
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img
      src='https://kkn1125.github.io/portfolio/assets/images/portfolio/ganttChart/gantt02.png'
      alt='sample'
      title='sample'
    />
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img
      src='https://kkn1125.github.io/portfolio/assets/images/portfolio/ganttChart/gantt03.png'
      alt='sample'
      title='sample'
    />
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img
      src='https://kkn1125.github.io/portfolio/assets/images/portfolio/ganttChart/gantt04.png'
      alt='sample'
      title='sample'
    />
...
<figure className='text-center'>
  <span className='w-inline-block'>
    <img
      src='https://kkn1125.github.io/portfolio/assets/images/portfolio/ganttChart/gantt05.png'
      alt='sample'
      title='sample'
    />
