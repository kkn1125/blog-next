...
<span className="w-inline-block">
   <img src="/assets/images/post/error/spring-update-error01.png" alt="sample" title="sample" />
...
<figure className="text-center">
<span className="w-inline-block">
   <img src="/assets/images/post/error/spring-update-error02.png" alt="sample" title="sample" />
   <figcaption>kimson</figcaption>
</span>
</figure>
