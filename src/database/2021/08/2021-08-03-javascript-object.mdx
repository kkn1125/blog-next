...
person은 일반적 선언된 변수의 하나이고, 객체인 human은 많은 프로퍼티를 가진 변수의 하나입니다. 수, 문자, 불리언, indefined 타입 외 모든 것이 객체
...
console.log(nb.contents), console.log(nb.author);
