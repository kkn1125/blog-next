...
![작업환경](/assets/images/post/exception/exception01.png)
...
![친절한 에러페이지](/assets/images/post/exception/exception02.png)
...
![에러테스트페이지](/assets/images/post/exception/exception03.png)

빨간 링크는 `/toast`라는 존재하지 않는 경로로 연결됩니다.

![에러테스트페이지](/assets/images/post/exception/exception04.png)
...
![404페이지](/assets/images/post/exception/exception05.png)
