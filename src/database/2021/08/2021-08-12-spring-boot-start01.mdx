...
![스프링부트 설치](/assets/images/post/springboot/springboot01.png)

노란박스는 legacy프로젝트를 생성하므로 boot는 아닙니다.
...
![스프링부트 프로젝트 생성](/assets/images/post/springboot/springboot02.png)

![스프링부트 프로젝트 생성](/assets/images/post/springboot/springboot03.png)

저는 이대로 설정하고 next를 누르겠습니다. ( 설명내용과 이미지에 네이밍차이가 있을 수 있습니다. )

![스프링부트 프로젝트 생성](/assets/images/post/springboot/springboot04.png)
...
![스프링부트 구조](/assets/images/post/springboot/springboot06.png)

### thymeleaf dependecy가 포함된 경우

![스프링부트 구조](/assets/images/post/springboot/springboot05.png)

빨간줄은 처음 생성때에 없는 것입니다.
...
![스프링부트 구동](/assets/images/post/springboot/springboot07.png)
...
![스프링부트 구동](/assets/images/post/springboot/springboot08.png)
...
![스프링부트 구동](/assets/images/post/springboot/springboot09.png)
...
![스프링부트 구동](/assets/images/post/springboot/springboot10.png)
