...
![exclude - password](/assets/images/post/react/react01.png)
...
const el = <h1 className=''>Hello Kimson!</h1>;
...
ReactDOM.render(
  // React element 생성해서 넣는 방식
  React.createElement("h1", { className: "" }, "Hello Kimson!!"),
