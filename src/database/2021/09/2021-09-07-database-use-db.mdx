...
modified: 2023-09-05 12:39:19 +0000
...
![헤로쿠](/assets/images/post/database/db02.png)
...
![스프링](/assets/images/post/database/db03.png)
...
![스프링](/assets/images/post/database/db04.png)
      ...
      document.getElementById("result").innerHTML += `
				<div class="container">
					<div class="p-3 border rounded-3 mb-3">
						<div><span class="badge bg-info">${data[i].id}</span><span>${
        data[i].name
      }</span></div>
						<div class="badge bg-primary">나이 ${data[i].age}</div>
						<div class="badge bg-primary">성별 ${
              data[i].gender == 1 ? "남" : data[i].gender == 2 ? "여" : ""
            }</div>
...
![스프링](/assets/images/post/database/db05.png)

1페이지 일때 db에 있는 내용이 잘 출력 됩니다.

![스프링](/assets/images/post/database/db06.png)
