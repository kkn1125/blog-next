...
modified: 2023-09-05 12:39:50 +0000
...
<div class="container text-center d-flex flex-wrap">
    <span className="wrap">
        <img src="/assetstest.jpg" alt="test" />
    </span>
    <span className="wrap">
        <img src="/assetstest2.png" alt="test" />
    </span>
</div>
```
...
![view](/assets/images/post/zoom/zoom01.png)
...
![view](/assets/images/post/zoom/zoom02.png)

이미지를 클릭하니 검은 배경에 닫기 버튼이 생겼습니다.

![view](/assets/images/post/zoom/zoom03.png)

여러 번 클릭하니 확대가 잘 됩니다. 지금은 스크롤 바가 있는 상태이지만 드래그까지 구현했기 때문에 필요없다 하시면 스크롤 비활성화 해도 됩니다.

아래는 `gif`입니다.

![view](/assets/images/post/zoom/zoom04.gif)
